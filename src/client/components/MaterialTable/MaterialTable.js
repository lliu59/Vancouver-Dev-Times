...
const EditableTable = ({
  ...
  // TODO: Submission need to be changed to base on type
  ...
  // TODO: Show alert that you have successfully approved
  ...
  const handlePressApprove = () => {
    setConfirmDialog(false);
    console.log('pending in approve submission' + JSON.stringify(state.pending));
