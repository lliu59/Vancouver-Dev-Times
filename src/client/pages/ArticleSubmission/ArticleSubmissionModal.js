                    ...
                    <div className={styles.innerBody}>
                        { (articleSubmitted || rssSubmitted) ?
                            (newRSS.loading || newPost.loading) ?
                                ...
                                (newRSS.error || newPost.error) ?
                                    (<div className={styles.confirmationMsg}>Submission failed. Either the URL is invalid or it is a duplicate submission (duplicate URL or title).</div>) :
