...
import { getApprovedResourcesByCategories, deleteArticle, editArticle, getAllApprovedResourcesByCategory } from '../../actions';
...
const CategoryPage = ({
    ...
    // console.log('posts by categories', currentCategoryContent)
    // const currentCategoryObj = currentCategoryContent.filter(obj => obj.category === params.category);
