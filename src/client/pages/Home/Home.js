...
const Home =({
    ...
    return (
        <div className={styles.flexGrid}>
            { postsByCategories.length > 0 && postsByCategories.map( category => (
                <div className={styles.gridCell}>
                    <div className={styles.gridCellHeader} onClick={() => getAllApprovedResourcesByCategory(category.category)}>
                    ...
                    <div className={styles.categoryContainer}>
                        <div>
                            {
                                category.articles.map(item => renderBasedOnUserType(item))
                            }
                        </div>
                    </div>
                    {deleteMessageOpen?
