...
//   // getUserType = () => {
//   //   return this.state.user.permissionType;
//   // };

//   render() {
//       console.log(this.props.loggedIn);
//       let routesBasedOnLoginStatus = this.props.loggedIn?
//       (
//         <div>
//           <Header/>
//           <Route path='/' render={() => <Redirect to="/home"/>}/>
...
//           <Route path='/manage-users' component={ManageUsers}/>
//           <Route path='/review-submissions' component={Scheduler}/>
//           <Route path='/submit-article' component={ArticleSubmission}/>
//           <Route path='/account-profile' component={MyAccount}/>
//           <Contact/>
//         </div>
//       )
//       :
