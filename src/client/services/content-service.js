...
export function getAllResourcesService() {
    console.log('making call to get all resources');
    return axios
        .get('/api/resources')
}
...
export function getAllPendingCountService(payload) {
    console.log("making call to get pending count");
    return axios
...
export function approveBlogSubmissionService(payload) {
    console.log("making call to approve Blog submission");
    return axios
        .post('/api/approvals', {
            user: payload.user,
            url: payload.url
...
export function approveRssSubmissionService(payload) {
    console.log("making call to approve RSS submission");
    return axios
...
export function deleteSubmissionService(payload) {
    console.log("making call to delete submission");
    return axios
