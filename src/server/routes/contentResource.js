...
// router.get('/api/resources', verifyToken, (req, res) => {
...
// router.get('/api/resources/pending', verifyToken, (req, res) => {
...
// Get all content approved by some users
// router.get('/api/resources/approved/user', verifyToken, (req, res) => {
...
// router.get('/api/resources/count', verifyToken, (req, res) => {
...
// router.get('/api/resources/approved', verifyToken, (req, res) => {
...
// router.get('/api/resources/approvedByCategory/:maxNum', verifyToken, (req, res) => {
...
// router.get('/api/post/:title', verifyToken, (req, res) => {
...
// router.get('/api/resources/search', verifyToken, (req, res) => {
...
const approveCB = function (req, res, next) {
  ...
  db.query(updateQuery + newApprovalQuery, [new Date(), url, user, url], (error) => {
    console.log(updateQuery + newApprovalQuery);
    if (error) {
...
const checkRSSApprovalCB = function (req, res) {
  const { url } = req.body;
...
// router.delete('/api/resources', verifyToken, (req, res) => {
