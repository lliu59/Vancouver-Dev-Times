 ...
 */
router.put('/api/user/permissions', (req, res) => {
  // jwt.verify(req.token, 'my-secret', (err, authData) => {
  //   if (err) {
  //     console.log('request is not authenticated with JWT token.');
  //     res.status(401).send('unauthorized operation');
...
router.put('/api/user/company/', (req, res) => {
// router.put('/api/company/', verifyToken, (req, res) => {
  // jwt.verify(req.token, 'my-secret', (err, authData) => {
  //   if (err) {
  //     console.log('request is not authenticated with JWT token.');
  //     res.status(401).send('unauthorized operation');
...
router.put('/api/user/subscription', (req, res) => {
  // jwt.verify(req.token, 'my-secret', (err, authData) => {
  //   if (err) {
  //     console.log('request is not authenticated with JWT token.');
  //     res.status(401).send('unauthorized operation');
 ...
 */
// router.get('/api/companies', verifyToken, (req, res) => {
 ...
 */
// router.delete('/api/company', verifyToken, (req, res) => {
router.delete('/api/company', (req, res) => {
  ...
  const userCompQuery = 'DELETE FROM USER_COMPANY WHERE companyName IN (?);';
